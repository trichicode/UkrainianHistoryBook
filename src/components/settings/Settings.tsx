...
const SettingsPanel: FC<{ isPanelOpen: boolean; closePanel: () => void }> = ({
  isPanelOpen,
  closePanel,
}) => {
  ...
  return (
    <div>
      {isPanelOpen && <div className="backPanel" onClick={closePanel}></div>}
      <div
        id="settingsPanel"
        ...
        <div className="audioControls-wrapper">
          ...
          <h1 className="companyName"> • TRICHICODE </h1>
        </div>
